      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-bold mb-4">Conference 2024</h2>
            <p className="text-gray-400 mb-4">
              An international conference bringing together industry experts, thought leaders, 
              and innovators to exchange ideas and foster collaboration.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>info@conference2024.example</li>
              <li>+1 (555) 123-4567</li>
              <li>123 Conference Way<br />City, State 12345</li>
            </ul>
          </div>
        </div>
